...
/*
 * Figma: Desktop - 26 (node 3:492), 1920 x 1080
 * 같은 화면의 다른 상태: Desktop - 27 (이메일 입력됨), Desktop - 28 (에러)
 *
 * lg(1024px) 이상에서 시안 실측값과 일치한다.
 *   헤더        0 ~ 80
 *   "로그인"     top 313  h67
 *   이메일       top 431  h54 w501   gap 51
 *   비밀번호      top 499            gap 14
 *   이메일 저장    top 571  h28      gap 18
 *   로그인 버튼    top 645            gap 46
 *   회원가입 버튼   top 713            gap 14
 *
 * **2026-08-13 개편에서 세로 위치가 내려갔다** (제목 260 → 313, 나머지 +58).
 * 간격은 제목→이메일만 46 → 51로 바뀌고 나머지는 그대로다.
 *
 * 체크박스 **행 높이는 28**이다 (박스는 18이지만 라벨이 20px x 1.4 = 28).
 * 이걸 18로 착각하면 버튼 간격을 56으로 잡아 10px 밀린다 — 실측으로 잡았다.
 *   바닥 767 → 아래 여백 1080 - 767 = 313
 *
 * 전부 left 710 w 501이다. 1920 - 710 - 501 = 709라 0.5px 비대칭인데
  ...
  return (
    <div className="min-h-svh w-full bg-white">
      ...
      <main className="flex flex-col items-center px-5 pb-16 sm:px-8 lg:pb-[313px]">
        ...
        <div
          className={`${COLUMN} mt-8 flex flex-col gap-[14px] lg:mt-[51px]`}
        >
          <TextField
            tone="login"
            type="email"
