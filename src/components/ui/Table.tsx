 ...
 * **헤더 행 끝의 꺾쇠 아이콘(옛 node `1:26`)은 x 1396~1416이라 완전히 잘려 보이지 않는다.**
 * ⚠️ 2026-08-13 시안 개편에서 이 테이블이 **1452x626 / 컬럼 4개(회의명·프로젝트·주요 안건·날짜)**로
 * 바뀌었다. 아래 수치는 전부 옛 시안(1460x556 / 컬럼 3개) 기준이라 재구현 때 다시 잴 것.
